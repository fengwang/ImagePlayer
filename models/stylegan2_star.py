...
def generate( image_widget ):
    ...
    if generator is None:
        image_widget.download_remote_model( "stylegan2_star", "https://github.com/fengwang/ImagePlayer/releases/download/stylegan2_star/checkpoint" )
        image_widget.download_remote_model( "stylegan2_star", "https://github.com/fengwang/ImagePlayer/releases/download/stylegan2_star/ckpt-0.data-00000-of-00001" )
        local_model_path = image_widget.download_remote_model( "stylegan2_star", "https://github.com/fengwang/ImagePlayer/releases/download/stylegan2_star/ckpt-0.index" )
    ...
    tmp_file = os.path.join( tempfile.gettempdir(), f'{random_file_prefix}_stylegan2_star.png' )
...
def interface():
    ...
    return 'RandomStar', detailed_implementation
