...
def generate( image_widget ):
    ...
    if generator is None:
        image_widget.download_remote_model( "stylegan2_wanghong", "https://github.com/fengwang/ImagePlayer/releases/download/model_wanghong/checkpoint" )
        image_widget.download_remote_model( "stylegan2_wanghong", "https://github.com/fengwang/ImagePlayer/releases/download/model_wanghong/ckpt-0.data-00000-of-00001" )
        local_model_path = image_widget.download_remote_model( "stylegan2_wanghong", "https://github.com/fengwang/ImagePlayer/releases/download/model_wanghong/ckpt-0.index" )
        model_path = os.path.dirname( local_model_path )
        print( f'stylegan2::girl::{model_path=}' )
        #current_folder = dirname(abspath(__file__))
        #model_path = os.path.join( current_folder, 'stylegan2/girl_model' )
    ...
    tmp_file = os.path.join( tempfile.gettempdir(), f'{random_file_prefix}_stylegan2_girl.png' )
...
def interface():
    ...
    return 'RandomGirl', detailed_implementation
